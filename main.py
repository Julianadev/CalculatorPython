...
display_text = Entry(main, font=("arial", 20, "bold"), textvariable=input_value, bd=30, insertwidth=4,
                     bg="black", justify=RIGHT, fg="white")
...
btn_add = Button(main, padx=16, bd=8, fg="black",  bg="yellow",
...
btn_sub = Button(main, padx=16, bd=8, fg="black",  bg="yellow",
                 font=("arial", 20, "bold"), text="-", command=lambda: buttonClick("-"))
...
btn_mul = Button(main, padx=16, bd=8, fg="black",  bg="yellow",
                 font=("arial", 20, "bold"), text="x", command=lambda: buttonClick("*"))
...
btn_div = Button(main, padx=16, bd=8, fg="black",  bg="yellow",
                 font=("arial", 20, "bold"), text="/", command=lambda: buttonClick("/"))
